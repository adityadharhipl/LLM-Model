...
export const sendMessage = async (message, history, provider, model, apiKey) => {
  try {
    ...
    const response = await axios.post(`${API_URL}/api/chat`, { message, history, provider, model, apiKey }, config);
